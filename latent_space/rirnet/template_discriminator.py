...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv1 = nn.Conv1d(2, 128, 25, stride=1, padding=12)
        ...
        self.conv5 = nn.Conv1d(128, 128, 3, stride=1, padding=1)
        self.conv6 = nn.Conv1d(128, 128, 3, stride=1, padding=1)
        self.conv7 = nn.Conv1d(128, 128, 3, stride=1, padding=1)
        self.conv8 = nn.Conv1d(128, 256, 3, stride=1, padding=1)
