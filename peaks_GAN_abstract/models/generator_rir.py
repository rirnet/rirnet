...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv2 = nn.Conv1d(16, 16, 51, stride=1, padding=25)
        self.conv3 = nn.Conv1d(16, 16, 5, stride=1, padding=2)
        self.conv4 = nn.Conv1d(16, 16, 5, stride=1, padding=2)
        self.conv5 = nn.Conv1d(16, 16, 5, stride=1, padding=2)
        self.conv6 = nn.Conv1d(16, 16, 5, stride=1, padding=2)
        ...
        self.bn5 = nn.BatchNorm1d(16, affine=True)
        self.bn6 = nn.BatchNorm1d(16, affine=True)
