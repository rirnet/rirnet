...
class Model:
    ...
    def generate_plot(self):
        ...
        fig = plt.figure()
        plt.plot(self.target_im_train[0,:]*44100/1000, self.target_im_train[1,:], 'o-', linewidth=0.05, markersize=2, label='Target')
        plt.plot(self.output_im_train[0,:]*44100/1000, self.output_im_train[1,:], 'x-', linewidth=0.05, markersize=2, label='Output')
        plt.grid(True)
        plt.legend()
        ...
        fig = plt.figure()
        plt.plot(self.target_im_eval[0,:]*44100/1000, self.target_im_eval[1,:], 'o', linewidth=0.05, markersize=2, label='Target')
        plt.plot(self.output_im_eval[0,:]*44100/1000, self.output_im_eval[1,:], 'x', linewidth=0.05, markersize=2, label='Output')
        plt.grid(True)
        plt.legend()
