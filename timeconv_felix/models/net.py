...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(1, 8, (7,7), padding=(3,3))
        self.conv2 = nn.Conv2d(8, 32, (1,5), padding=(0,2))
        ...
        self.deconv1 = nn.ConvTranspose2d(128, 64, (1,3), (1,2), padding=(0,1), output_padding=(0,1))
        self.deconv2 = nn.ConvTranspose2d(64, 32, (1,3), (1,2), padding=(0,1))#, output_padding=(0,1))
        self.deconv3 = nn.ConvTranspose2d(32, 16, (1,3), (1,2), padding=(0,1))#, output_padding=(0,1))
        self.deconv4 = nn.ConvTranspose2d(16, 8, (1,3), (1,2), padding=(0,1))#, output_padding=(0,1))
        self.deconv5 = nn.ConvTranspose2d(8, 4, (1,3), (1,2), padding=(0,0), output_padding=(0,1))
    ...
    def args(self):
        ...
        parser.add_argument('--train_db_path', type=str, default='../../db_fft/train.csv',
