...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(3, 5, 9, padding=5)
        ...
        self.conv9 = nn.Conv2d(5, 3, 3, padding=1)
        self.ct1 = nn.ConvTranspose2d(10,10,4,stride=2,padding=1,output_padding=(0,1))
        self.ct2 = nn.ConvTranspose2d(10,10,4,stride=2,padding=1,output_padding=(1,1))
        self.ct3 = nn.ConvTranspose2d(10,10,4,stride=2,padding=1)
        self.ct4 = nn.ConvTranspose2d(10,10,4,stride=2,padding=1,output_padding=(1,0))
