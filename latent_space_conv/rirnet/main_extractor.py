...
class Model:
    ...
    def generate_plot(self):
        ...
        plt.subplot(3,2,3)
        plt.plot(self.latent_target_im_train[:,0], '--ok', linewidth=0.5, markersize=3, label='target0')
        plt.plot(self.latent_target_im_train[:,1], '--xk', linewidth=0.5, markersize=3, label='target1')
        plt.plot(self.latent_output_im_train[:,0], '-o', linewidth=0.5, markersize=3, label='output0')
        plt.plot(self.latent_output_im_train[:,1], '-x', linewidth=0.5, markersize=3, label='output1')
        plt.grid(True)
        plt.legend()
        plt.title('Train latent')

        plt.subplot(3,2,4)
        plt.plot(self.latent_target_im_eval[:,0], '--ok', linewidth=0.5, markersize=3, label='target0')
        plt.plot(self.latent_target_im_eval[:,1], '--xk', linewidth=0.5, markersize=3, label='target1')
        plt.plot(self.latent_output_im_eval[:,0], '-o', linewidth=0.5, markersize=3, label='output0')
        plt.plot(self.latent_output_im_eval[:,1], '-x', linewidth=0.5, markersize=3, label='output1')
        plt.grid(True)
        plt.legend()
