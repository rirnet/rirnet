...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv1a = nn.Conv2d(3, 6, 65, stride=2, padding=32)
        self.conv1b = nn.Conv2d(3, 6, 33, stride=2, padding=16)
        self.conv1c = nn.Conv2d(3, 6, 17, stride=2, padding=8)
        self.conv1d = nn.Conv2d(3, 6, 9, stride=2, padding=4)
        self.conv1e = nn.Conv2d(3, 6, 5, stride=2, padding=2)
        self.conv1f = nn.Conv2d(3, 6, 3, stride=2, padding=1)

        self.bn1a = nn.BatchNorm2d(6)
        self.bn1b = nn.BatchNorm2d(6)
        self.bn1c = nn.BatchNorm2d(6)
        self.bn1d = nn.BatchNorm2d(6)
        self.bn1e = nn.BatchNorm2d(6)
        self.bn1f = nn.BatchNorm2d(6)

        self.conv2a = nn.Conv2d(6, 2, 65, stride=2, padding=32)
        self.conv2b = nn.Conv2d(6, 2, 33, stride=2, padding=16)
        self.conv2c = nn.Conv2d(6, 2, 17, stride=2, padding=8)
        self.conv2d = nn.Conv2d(6, 2, 9, stride=2, padding=4)
        self.conv2e = nn.Conv2d(6, 2, 5, stride=2, padding=2)
        self.conv2f = nn.Conv2d(6, 2, 3, stride=2, padding=1)
    ...
    def forward(self, x):
        ...
        x3 = (F.relu(self.conv2c(x3)))
        x4 = (F.relu(self.conv2d(x4)))
        x5 = (F.relu(self.conv2e(x5)))
        x6 = (F.relu(self.conv2f(x6)))
