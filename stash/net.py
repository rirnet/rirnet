...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv10 = nn.Conv2d(1, 1, 3, stride=1, padding=1)
        ...
        self.bnl1 = nn.BatchNorm1d(8192, affine=True)
        self.bnl2 = nn.BatchNorm1d(2048, affine=True)
    ...
    def args(self):
        ...
        parser.add_argument('--db_path', type=str, default='/home/felix/rirnet/database/peaks_transformed',
